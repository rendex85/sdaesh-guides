...
![СКРИН 08 — форма копирования потока](screens/08-stream-copy.png)
...
- Ссылка на видео (обязательно)
- Ссылка на документ (обязательно)
- Ссылка на PR (обязательно)
- Ссылка на LeetCode-видео — появляется и становится обязательной, **если дедлайн прошёл** (для просроченных сдач).
